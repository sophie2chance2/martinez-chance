...
function rsvpForms() {
  return `<div class="rsvp-form-area">
    ...
    <form class="rsvp-step" data-rsvp-response><div class="response-heading"><p class="section-title">Invitation<span class="translation">Invitación</span></p></div><label for="rsvp-address-street">Street address / Dirección</label><input id="rsvp-address-street" name="addressStreet" type="text" autocomplete="address-line1"><label for="rsvp-address-city">City / Ciudad</label><input id="rsvp-address-city" name="addressCity" type="text" autocomplete="address-level2"><label for="rsvp-address-state">State / Estado</label><input id="rsvp-address-state" name="addressState" type="text" autocomplete="address-level1"><label for="rsvp-address-zip">ZIP code / Código postal</label><input id="rsvp-address-zip" name="addressZip" type="text" autocomplete="postal-code"><div class="response-heading"><p class="section-title">Attendance<span class="translation">Asistencia</span></p></div><div data-guest-responses></div><div class="response-heading"><p class="section-title">Email<span class="translation">Correo electrónico</span></p></div><label for="rsvp-email">Where should we send your confirmation? / ¿A dónde enviamos la confirmación?</label><input id="rsvp-email" name="email" type="email" required><button class="primary-button" type="submit">Send RSVP / Enviar RSVP</button></form>
